...
import (
	...
	httpadapter "github.com/viralforge/mesh/services/data-ai/M95-referral-analytics-service/internal/adapters/http"
...
func NewRuntime(_ context.Context, configPath string) (*Runtime, error) {
	...
	svc := application.NewService(application.Dependencies{
		Config:    application.Config{ServiceName: cfg.ServiceID, IdempotencyTTL: cfg.IdempotencyTTL, EventDedupTTL: cfg.EventDedupTTL, OutboxFlushBatchSize: cfg.OutboxFlushBatchSize},
		Warehouse: repos.Warehouse, Exports: repos.Exports, Idempotency: repos.Idempotency, EventDedup: repos.EventDedup, Outbox: repos.Outbox,
	...
	grpcadapter.Register(grpcServer, grpcadapter.NewReferralAnalyticsInternalServer(svc))
