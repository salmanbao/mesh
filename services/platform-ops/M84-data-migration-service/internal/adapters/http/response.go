...
func writeError(w http.ResponseWriter, status int, code, message, requestID string) {
	writeJSON(w, status, contracts.ErrorResponse{Status: "error", Code: code, Message: message, RequestID: requestID, Error: contracts.ErrorPayload{Code: code, Message: message, RequestID: requestID}})
}
